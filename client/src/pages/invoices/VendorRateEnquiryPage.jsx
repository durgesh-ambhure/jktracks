...
export default function VendorRateEnquiryPage() {
  const [checked, setChecked] = useState(false);

  return (
    <div>
      <PageHeader title="Vendor Rate Enquiry" subtitle="Look up a vendor rate by route/weight without booking" />
        ...
        <div className="card__body">
          ...
          {checked && (
            <div style={{ marginTop: 'var(--space-5)' }}>
              <EmptyState title="No rate card configured yet" description="Once vendor rate cards are imported, matching rates will show here." />
            </div>
          )}
        </div>
      </div>
