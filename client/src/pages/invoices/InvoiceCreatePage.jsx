...
export default function InvoiceCreatePage() {
  ...
  const onSubmit = async (values) => {
    ...
    setError('');
    try {
      const res = await invoiceService.create({ ...values, invoiceType: 'STANDARD' });
      ...
      <div className="card">
        <div className="card__body">
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <p className="form-hint">Generates a real bill from every non-cancelled shipment for this client booked in the date range.</p>
